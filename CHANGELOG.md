...
- 2b93670: Add Match API for exhaustive pattern matching, Schedule API for composable retry strategies, and Duration API for type-safe time handling. Enhance resource management documentation with real-world scenarios.
